  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 style={{ margin: 0 }}>━━ GREENWAY PEST SOLUTION ━━</h1>
         <h1 style={{ margin: 0, color:'#011' }}> 2023 Premium Add-Ons</h1>
...
At our pest control company, we're committed to providing the best protection for your home and family. Our team of experts will work with you to create a customized plan tailored to your specific needs. With our new services, you can trust that your home will be protected from pests all season long.
      ...
      >
        <h2 style={{ margin: 0, fontWeight: 'bold', textAlign: 'center' }}>Ready to get rid of pests?</h2>
         <div style={{ width: '100%', height: '1px', backgroundColor: '#35764B', margin: '1rem 0' }} />
        <p style={{  textAlign: 'center' }}>We're here to help. <br/> Contact us to get a quote.</p>
        <button style={{ marginTop:"20px", padding: '.75rem 1.5rem', backgroundColor: '#35764B', color: 'white', borderRadius: '0.25rem', border: 'none', cursor: 'pointer' }}>HERE</button>
      </div>
      <div
        style={{
          position: 'absolute',
